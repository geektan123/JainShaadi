...
public class FamilyEdit02 extends DialogFragment {
    LinearLayout layout;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.activity_edit_family2, container, false);
        ...
        Spinner stateSpinner = view.findViewById(R.id.spinner_indian_states);
        LinearLayout NextLay = view.findViewById(R.id.Next);
...
//                                Toast.makeText(family_information_form2.this, "All fields are mandatory", Toast.LENGTH_SHORT).show();
        ...
        ArrayAdapter<String> arrayAdapter8 = new ArrayAdapter<>(requireContext(), android.R.layout.simple_spinner_item, arrayAdapter3);
...
//                                Toast.makeText(family_information_form2.this, "Please Complete the values", Toast.LENGTH_SHORT).show();
                ...
                NextLay.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        if(selectedState.equals("Select State") || selectedDistrict.equals("Select District") || Family.isEmpty() || Family.equals("-Select-") ||number.equals("-Select-")|| number.isEmpty())
                        {
