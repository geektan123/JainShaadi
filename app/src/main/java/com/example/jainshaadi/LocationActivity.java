...
// Create a Map to hold the data
                ...
                userData.put("below_category", spinners);
                userData.put("category", category);
                userData.put("subcategory", subcategory);
                userData.put("username", username);
                userData.put("dates", dates);
                userData.put("spinnerValue1", spinnerValue1);
                userData.put("spinnerValue2", spinnerValue2);
                userData.put("selectedState", selectedState);
                userData.put("selectedDistrict", selectedDistrict);
